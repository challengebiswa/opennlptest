...
public class CustomClassifierTrainer {
	//Where to save the model once trained	
	  static String onlpModelPath = "./models/en-ner-asiannames.bin";
	    // location of the training data set
	    static String trainingDataFilePath = "E:\\projects\\Nlp\\nlp-intent-toolkit-master\\nlp-intent-toolkit-master\\example\\weather\\train\\asiannames.txt";
